...
export default function ValueChain(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/chain7.glb')
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh
          ...
          position={[0.55, -0.008, 0]}
          rotation={[-0.034, 0.082, 0.004]}
          scale={[-0.194, -0.008, -0.186]}
        />
        <mesh
          name="2"
...
useGLTF.preload('/models/chain7.glb')
