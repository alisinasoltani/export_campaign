...
const Services = () => {
    ...
    //         ease: 'none',
    //         scrollTrigger: {
    //             trigger: "#services", // The container of all sections
    //             start: "top top", // Start animation when the top reaches the top of the viewport
    //             end: () => `+=${window.innerWidth * (sections.length - 1)}`, // Total width of all sections
    //             pin: true, // Stops vertical scroll during animation
    ...
    // }, {scope: servicesRef})
  return (
    <div className="w-full h-[100vh] flex justify-normal items-center z-[90]" ref={servicesRef}>
        <div className="w-full h-[100vh] flex justify-normal items-center px-12 py-8" id="services">
            {/* <div className="min-w-full h-full bg-red-400 service">
                سلام
            </div>
            <div className="min-w-full h-full bg-red-400 service">
                سلام1
