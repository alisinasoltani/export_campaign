...
const Service = ({ title, subtitle, isNew, img, href, btnTitle, description }: ServiceProps ) => {
  return (
    <div className="service flex md:flex-row-reverse flex-col justify-between items-center gap-4 px-8 pb-10 my-3 pt-6 irsansx relative rounded-[0.6rem]">
        <div className="flex flex-col justify-start items-end gap-1">
            <h2 className="text-right text-lg irsansx-mid">
                {title}
            </h2>
            <h3 className="text-right text-base text-[#575757] irsansx-mid">
                {subtitle}
            </h3>
        ...
        <div className="service-btn flex justify-center items-center absolute -bottom-[1rem] right-[2rem]">
            <button type="button" className="flex justify-center items-center text-[16px] irsansx-mid 
        ...
        {isNew && 
        <div className="flex justify-center items-center bg-[#F5006A] irsansx text-[9px] text-white font-bold text-center absolute -top-2 -left-2
